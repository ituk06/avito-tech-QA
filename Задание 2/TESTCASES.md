...
Шаги:  
Отправить GET-запрос на /api/1/{seller_id}/item, где {seller_id} — ID продавца.  
...
Шаги:  
Отправить GET-запрос на /api/1/item/{fake_id}, где {fake_id} — заведомо несуществующий ID (например, 00000000-0000-0000-0000-000000000000).  
...
Отправить GET-запрос на /api/1/{seller_id}/item.  
